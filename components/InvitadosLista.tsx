            ...
            <article key={inv.id} className="invitado-completo">
              ...
              <div className="invitado-completo__contenido">
                <div className="invitado-completo__encabezado">
                  ...
                  {(inv.linkedin || inv.instagram || inv.web || inv.academia || inv.facebook || inv.youtube) && (
                    <div className="invitado-completo__links">
                      ...
                      {inv.academia && (
                        <a href={inv.academia} target="_blank" rel="noopener noreferrer" className="invitado-completo__link" aria-label="Academia.edu">
                          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M11.805 2.003 6.553 16.5H4.5v1.5h6v-1.5H8.91l1.26-3.5h4.665l1.259 3.5H14.5v1.5h6.002v-1.5h-2.053L13.197 2.003h-1.392zm.696 2.45 1.87 5.197h-3.74l1.87-5.197zM5.5 19.5v1.497h13V19.5H5.5z"/></svg>
                        </a>
                      )}
                      {inv.web && (
