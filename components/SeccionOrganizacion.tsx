    ...
    <section className="section" id="organizacion">
      ...
      <div style={{ display: 'flex', gap: '4rem', marginTop: '2.5rem', flexWrap: 'wrap' }}>
        ...
        <div style={{ maxWidth: '320px' }}>
          ...
          <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem', borderTop: '1px solid var(--border-faint)', paddingTop: '0.5rem', borderBottom: '1px solid var(--border-faint)', paddingBottom: '0.5rem' }}>
            {COORDINADORES.map(n => (
        ...
        <div style={{ maxWidth: '440px' }}>
          ...
          <p style={{ fontSize: '1rem', color: '#444', lineHeight: 1.9, borderTop: '1px solid var(--border-faint)', borderBottom: '1px solid var(--border-faint)', paddingTop: '0.5rem', paddingBottom: '0.5rem' }}>
